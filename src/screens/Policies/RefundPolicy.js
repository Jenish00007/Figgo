      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <Text style={[styles.paragraph, { color: currentTheme.fontSecondColor }]}>
            Figgo offers refunds under the following circumstances:
          ...
          <Text style={[styles.paragraph, { color: currentTheme.fontSecondColor }]}>
            For any questions about our refund policy, please contact our customer support team at refunds@figgo.com
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
