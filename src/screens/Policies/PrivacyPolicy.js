      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <Text style={[styles.paragraph, { color: currentTheme.fontSecondColor }]}>
            At Figgo, we collect various types of information to provide and improve our service:
          ...
          <Text style={[styles.paragraph, { color: currentTheme.fontSecondColor }]}>
            If you have any questions about this Privacy Policy, please contact us at privacy@figgo.com
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
