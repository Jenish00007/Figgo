    ...
    <SafeAreaView style={[styles.container, { backgroundColor: currentTheme.themeBackground }]}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <Text style={[styles.paragraph, { color: currentTheme.fontSecondColor }]}>
            For any questions about our cancellation policy or assistance with cancelling an order, please contact our customer support team at cancellations@figgo.com
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
